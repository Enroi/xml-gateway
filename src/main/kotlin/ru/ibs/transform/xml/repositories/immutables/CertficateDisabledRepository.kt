...
import ru.ibs.transform.xml.entities.immutables.CertificateDisabled
import ru.ibs.transform.xml.entities.immutables.CertificateEnabled
import java.time.Instant

interface CertficateDisabledRepository: JpaRepository<CertificateDisabled, Long> {

    @Modifying
    @Transactional
    @Query(
        value = """
        MERGE INTO certificate_disabled AS target
        USING (VALUES (
    ...
    fun existsByCertificateHash(certificateHash: ByteArray): Boolean
